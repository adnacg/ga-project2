      ...
      return (
        <div key={currentRequest.id} id="my-card" class="card">
          ...
          <div class="card-action">
            <form
              method="get"
              action={"/user/" + currentRequest.requester_id + "/other"}
            >
              <input
                type="submit"
            ...
            <a
              class="waves-effect waves-light btn-small"
              href={"/request/" + currentRequest.id + "/accept"}
            >
              Accept
            </a>
            &nbsp;&nbsp;&nbsp;
            <a
              class="waves-effect waves-light btn-small"
              href={"/request/" + currentRequest.id + "/decline"}
            >
              Decline
            </a>
          </div>
        ...
        <div class="container">
          <div class="row">
            <div class="col s12 m8 center offset-m2">
              {arrayOfRequests.length > 0 ? (
                <div>{arrayOfRequests}</div>
              ) : (
                <div id="my-yellow-text">
                  <h4>Sorry, no requests came in yet :(</h4>
                  <br />Why not try to find a jamming partner from our extensive
                  list?<br />
                  <br />
                  <a class="waves-effect waves-light btn-small" href="/post">
                    Let's do it!
                  </a>
                  <br />
                  <br />
