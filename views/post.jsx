      ...
      >
            ...
            <div class="container">
              ...
              <div class="row center">
                <h6 class="header col s12 light">
                  <strong>Join your fellow musicians today</strong>
                </h6>
              </div>
            </div>
          </div>
          <div class="parallax">
            <img src="/assets/images/post.jpg" alt="img1" />
          </div>
        </ParallaxContainer>
        ...
        <div class="container col s12 right-align">
          <ul class="pagination">
            ...
            <li id="my-yellow-background" class="active">
              <a href="#!">1</a>
            </li>
