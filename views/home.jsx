            ...
            <LayoutContainer>
                  ...
                  <div class="container">
                    <div class="section">
                      <div class="row">
                        ...
                        <div class="col s12 m3">
                          <div class="icon-block">
                            <h2 class="center brown-text"><i class="material-icons">replay</i></h2>
                  ...
                  <div class="parallax-container valign-wrapper">
                    <div class="section no-pad-bot">
                      <div class="container">
                        <div class="row left">
                          <h5 class="header s12 light m6">Why Jam Away?</h5>
                    ...
                    <div class="parallax"><img src="/assets/images/background2.jpg" alt="img2" /></div>
                  </div>
                    ...
                    <div class="section">
                      ...
                      <div class="row">
                        <div class="col s12 center">
                          ...
                          <h4>Browse The List Now</h4>
                          <p class="center-align light">Find the right partner and jam your hearts away!</p>
                        </div>
                      </div>
