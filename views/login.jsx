            ...
            <div class="container">
              ...
              <div class="row center">
                <h6 class="header col s12 light">
                  <strong>Enter your email and password to login</strong>
                </h6>
              </div>
            </div>
          </div>
          <div class="parallax">
            <img src="/assets/images/login.jpg" alt="img1" />
          </div>
        </ParallaxContainer>
          ...
          <form class="col s12" method="post" action="/user/login">
            ...
            <div class="row">
              <div class="col s12 m6 offset-m3">
                <input
                  class="right waves-effect waves-light btn s12"
                  type="submit"
                  value="Login"
                />
                <br />
                <br />
                <p id="my-yellow-text" class="right">
                  New to Jam Away? Create an account{" "}
                  <a
                    id="my-yellow-text"
                    class="underlined"
                    href="/user/register"
