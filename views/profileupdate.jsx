          ...
          <div class="row">
            <div class="col s12 m6 center offset-m3">
              <form
                class="col s12"
                method="post"
                action={"/user/" + this.props.user_id}
              >
                ...
                <div class="row">
                  <div id="my-input-box" class="input-field col s12">
                    ...
                    <span
                      ...
                      data-success="right"
                    >
                      Describe yourself so your fellow musicians get to know
                      you! eg. What other musical talent you posses that are not
                      listed here?
                    </span>
                  </div>
                </div>
              ...
              <form
                class="delete-acc col s12 center"
                method="post"
                action={"/user/" + this.props.user_id}
              >
                <div class="right">
